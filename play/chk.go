...
func (chk *Chk) BuildLauncher() error {
	...
	launcherFilename := "check_command.sh"
	...
	outputAppend("# check_command launcher generated by snip on " + nowText + "\n\n")
	outputAppend(strings.Join(chk.Command, " "))

	chk.Logger.Debugf("writed check_command launcher to %s", launcherFile)
